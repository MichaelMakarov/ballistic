 ...
 *
 */
inline constexpr double JD2000{ 2451545 };
/**
 * @brief Юлианская дата для 1 января 1970, 00:00
 *
 */
inline constexpr double JD1970{ 2440587.5 };
/**
 * @brief Кол-во микросекунд в секунде
 *
 */
inline constexpr long long microseconds{ 1'000'000 };
/**
 * @brief Кол-во микросекунд в сутках
 *
 */
inline constexpr long long mcs_per_day{ 86400 * microseconds };
